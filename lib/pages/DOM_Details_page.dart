...
class DomDetailsPage extends StatefulWidget {
  /*
  final fnb Fnb;
  ...
  */
  ...
  @override
  _DomDetailsPageState createState() => _DomDetailsPageState();
}

class _DomDetailsPageState extends State<DomDetailsPage> {
  /*
